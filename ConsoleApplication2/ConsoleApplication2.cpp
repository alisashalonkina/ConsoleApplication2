...
//Вариант 25.
//На заданном отрезке, с заданным шагом изменения аргумента вычислить и поместить в массив F 30 значений функции e^(-x)*sin(6x), делённые на её последнее положительное значение. 
...
//Вариант 25.
//Дан текст, в котором с помощью тегов <strong> … </strong> выделены ФИО героев ВОВ. Напишите программу, которая выводит только ФИО героев.
//Учесть, что разметка может быть нарушена, то есть может отсутствовать открывающийся тег <strong> или закрывающийся тег </strong>. 
//Считать такие строки не выделенными.
